...
import type Fieldset from '../../configuration/Fieldset';
//helpers
...
export default function generate(
  ...
  //export function create(input: ProfileInput): Record<string, any>|null
  source.addFunction({
    isExported: true,
    name: method,
    parameters: [
      { name: 'input', type: `${fieldset.title}Input` }
    ],
